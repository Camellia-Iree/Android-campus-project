...
public class UploadActivity extends AppCompatActivity {
    ...
    private void submit() {
        ...
        MultipartBody.Part coverFrom = MultipartBody.Part.createFormData("from", USER_NAME);

        MultipartBody.Part coverTo = MultipartBody.Part.createFormData("to", to);

        MultipartBody.Part coverContent = MultipartBody.Part.createFormData("content", content);

        MultipartBody.Part coverImage = MultipartBody.Part.createFormData("image",
                "cover.png",
