...
public class MainActivity extends AppCompatActivity {
        ...
        notesAdapter = new NoteListAdapter(new NoteOperator() {
            ...
            public void deleteNote(Note note) {
                ...
                if(database == null) return;
                    ...
                    int rows = database.delete(TodoNote.TABLE_NAME, TodoNote._ID + "=?",
    ...
    private List<Note> loadNotesFromDatabase() {
        ...
        Cursor cursor = null;
        try{
            cursor = database.query(TodoNote.TABLE_NAME, null, null, null,
                    null, null,TodoNote.PRIORITY + " DESC");
                    // 按照TodoNote.PRIORITY排序
            while (cursor.moveToNext()) {
                ...
                long dateMs = cursor.getLong(cursor.getColumnIndex(TodoNote.DATE));
                int intState = cursor.getInt(cursor.getColumnIndex(TodoNote.STATE));
                int intPriority = cursor.getInt(cursor.getColumnIndex(TodoNote.PRIORITY));
